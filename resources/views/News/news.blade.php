                            ...
                            <div class="modal-body">
                              ...
                              <form action="{{ route('News.update', 'test') }}" method="POST" autocomplete="off"
                                ...
                                <select name="user" class="form-control SlectBox">
                                  <!--placeholder-->
                                  <option value="" selected disabled>Check User</option>
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="status" id="flexRadioDefault1"
                                    value="Published" @if (old('status', $ne->status) == 'Published') checked @endif>
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="status" id="flexRadioDefault2"
                                    value="Unpublish" @if (old('status', $ne->status) == 'Unpublish') checked @endif>
