                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale" data-toggle="modal"
                          href="#exampleModal{{ $ta->id }}  " title="edit">
                          <i class="las la-pen"></i>
                        </a>
                        {{-- Delete --}}
                        <a class="modal-effect btn btn-sm btn-danger" data-toggle="modal"
                          href="#modaldemo{{ $ta->id }}" title="delete">
                      ...
                      <!-- edit -->
                      <div class="modal fade" id="exampleModal{{ $ta->id }}" tabindex="-1" role="dialog"
                              ...
                              <form action="{{ route('Tags.update', 'test') }}" method="POST" autocomplete="off">
                                ...
                                <div class="form-group">
                                  ...
                                  <label for="recipient-name" class="col-form-label">Tag
                                    Name</label>
                                  <input class="form-control" value="{{ $ta->tag_name }}" name="tag_name" type="text">
                                </div>
                      ...
                      <!-- delete -->
                      <div class="modal" id="modaldemo{{ $ta->id }}">
                          ...
                          <div class="modal-content modal-content-demo">
                            ...
                            <form action="{{ route('Tags.destroy', 'test') }}" method="post">
                              ...
                              <div class="modal-body">
                                ...
                                <input type="hidden" name="id" value="{{ $ta->id }}">
                                <input type="text" class="form-control" value="{{ $ta->tag_name }}"
                                  name="cate_name" readonly>
                              </div>
          ...
          <div class="modal-body">
            <form action="{{ route('Tags.store') }}" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="section_name" name="tag_name">
              </div>
