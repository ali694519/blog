    ...
    <ul class="side-menu">
      ...
      <li class="slide">
        <a class="side-menu__item" href="{{ url('/' . ($page = 'home')) }}"><svg xmlns="http://www.w3.org/2000/svg"
          ...
          </svg><span class="side-menu__label">Home</span><span class="badge badge-success side-badge">1</span></a>
      </li>
      <li class="slide">
      ...
      <li class="slide">
        ...
        <ul class="slide-menu">
          <li><a class="slide-item" href="{{ url('/' . ($page = 'News')) }}"> news list</a></li>
      ...
      <li class="slide">
        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
          ...
          </svg><span class="side-menu__label">Tags</span><i class="angle fe fe-chevron-down"></i></a>
        <ul class="slide-menu">
          <li><a class="slide-item" href="{{ url('/' . ($page = 'Tags')) }}">List of tags</a></li>
      ...
      <li class="slide">
        ...
        <ul class="slide-menu">
          <li><a class="slide-item" href="{{ url('/' . ($page = 'Categories')) }}">List of category</a>
